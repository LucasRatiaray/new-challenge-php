...
<body class="min-h-screen flex flex-col">
            ...
            <ul class="space-y-2">
                ...
                <li>
                    ...
                    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                        <li>
                            <a href="/dashboard/pages" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">
                                <span class="flex-1 whitespace-nowrap">Liste</span>
                                <span class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-primary-800 bg-primary-100">
                                    (<?= htmlspecialchars(($totalPages), ENT_QUOTES, 'UTF-8') ?>)
                                </span>
                            </a>
                        </li>
                        <li>
                            <a href="/dashboard/pages/create" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">
                                <span class="flex-1 whitespace-nowrap">Ajouter</span>
                                <span class="bg-blue-100 text-blue-800 text-md font-semibold px-2.5 py-0.5 rounded-sm">
                                    +
                                </span>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                        <li>
                            <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">
                                <span class="flex-1 whitespace-nowrap">Liste</span>
                                <span class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-primary-800 bg-primary-100">
                                    (9)
                                </span>
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100">
                        ...
                        <span class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-primary-800 bg-primary-100">
                            <span class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm">+123</span>
                        </span>
                    </a>
                </li>
                <li>
                    ...
                    <ul id="dropdown-authentication" class="hidden py-2 space-y-2">
                        <li>
                            <a href="/dashboard/users" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">
                                <span class="flex-1 whitespace-nowrap">Liste</span>
                                <span class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-primary-800 bg-primary-100">
                        ...
                        <li>
                            <a href="/dashboard/users/create" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">
                                <span class="flex-1 whitespace-nowrap">Ajouter</span>
                                <span class="bg-blue-100 text-blue-800 text-md font-semibold px-2.5 py-0.5 rounded-sm">
                                    +
                                </span>
    ...
    <?php if (isset($_SESSION['success_message'])): ?>
        <div id="toast-success" class="absolute top-8 right-8 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm" role="alert">
            <div class="inline-flex items-center justify-center shrink-0 w-8 h-8 text-green-500 bg-green-100 rounded-lg">
                <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                </svg>
            </div>
            <div class="ms-3 text-sm font-normal"> <?= htmlspecialchars($_SESSION['success_message'], ENT_QUOTES, 'UTF-8') ?>.</div>
