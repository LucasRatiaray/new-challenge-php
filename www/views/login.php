<div class="container mx-auto p-4">
    <h1 class="flex justify-center my-8 items-center text-5xl font-extrabold text-black">
        ...
        <small class="ms-2 font-semibold text-gray-500 dark:text-gray-400">| Connectez-vous</small>
    </h1>
    <?php
    echo $formHtml;
    ?>
    <div class="flex justify-center mt-12">
        <a href="/register" class="text-blue-700 hover:underline">Créer un compte</a>
